                ...
                <div class="col-lg-12">
                    <div class="form-panel">
                            ...
                            <div class="col-sm-10">
                                <select name="type_id" class="form-control">
                                    ...
                                    <option value="<?= $type->getId();?>"
                                        <?= ($type->getId() === $estate->getType_id()) ? 'selected' : '' ?>>
                                        <?= $type->getType();?></option>
                                    <?php
                                            }
                                        ?>
                            ...
                            <div class="col-sm-10">
                                <select name="category_id" class="form-control">
                                    ...
                                    <option value="<?= $category->getId();?>"
                                        <?= ($category->getId() === $estate->getCategory_id()) ? 'selected' : '' ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" placeholder="Titre"
                                    value="<?= htmlspecialchars($estate->getTitle());?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="number" class="form-control"
                                    value="<?= htmlspecialchars($estate->getFloor());?>" name="floor"
                                    placeholder="Etage">
                            ...
                            <div class="col-sm-4">
                                <input type="number" class="form-control" value="<?= ($estate->getArea());?>"
                                    name="area" placeholder="Superficie">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select name="rooms" class="form-control">
                                    <option value="<?= ($estate->getRooms());?>"
                                        <?= $estate->getRooms() ? 'selected' : '' ?>><?= ($estate->getRooms()); ?>
                                    </option>
                            ...
                            <div class="col-sm-2">
                                <select name="bedrooms" class="form-control">
                                    <option value="<?= ($estate->getBedrooms());?>"><?= ($estate->getBedrooms());?>
                                    </option>
                                    <option value="0">0</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                            ...
                            <div class="col-sm-2">
                                <select name="bathrooms" class="form-control">
                                    <option value="<?= ($estate->getBathrooms());?>"><?= ($estate->getBathrooms());?>
                                    </option>
                                    <option value="0">0</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5" id="outside-area">
                                <input type="number" class="form-control" name="outside_area"
                                    value="<?= htmlspecialchars($estate->getOutside_area());?>"
                            ...
                            <div class="col-sm-10">
                                <select name="energy_id" class="form-control">
                                    <?php
                                            ...
                                            {
                                        ?>
                                    <option value="<?= $energy->getId();?>"
                                        <?= ($energy->getId() === $estate->getEnergy_id()) ? 'selected' : '' ?>>
                                        <?= $energy->getEnergy();?></option>
                                    <?php
                                            }
                                        ?>
                                </select>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="level_energy_diagnostic" class="form-control">
                                            <option
                                                value="<?= htmlspecialchars($estate->getLevel_energy_diagnostic());?>"
                                                <?= $estate->getLevel_energy_diagnostic() ? 'selected' : '' ?>>
                                                <?= htmlspecialchars($estate->getLevel_energy_diagnostic());?></option>
                                            <option value="aucun">Aucun</option>
                                            <option value="< 50 A">
                                                < 50 A</option> <option value="51 à 90 B">51 à 90 B
                                            </option>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="level_climat_diagnostic" class="form-control">
                                            <option
                                                value="<?= htmlspecialchars($estate->getLevel_climat_diagnostic());?>"
                                                <?= $estate->getLevel_climat_diagnostic() ? 'selected' : '' ?>>
                                                <?= ($estate->getLevel_climat_diagnostic()); ?></option>
                                            <option value="aucun">Aucun</option>
                                            <option value="< 50 A">
                                                < 50 A</option> <option value="51 à 90 B">51 à 90 B
                                            </option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="city"
                                    value="<?= htmlspecialchars($estate->getCity());?>" placeholder="Ville">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="number" name="building_year" class="form-control"
                                    value="<?= htmlspecialchars($estate->getBuilding_year());?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="excerpt"
                                    value="<?= htmlspecialchars($estate->getExcerpt());?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description"
                                    placeholder="Longue description"><?= htmlspecialchars($estate->getDescription());?></textarea>
                            ...
                            <div class="col-md-12">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    ...
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                        <img src="img/slider/<?= htmlspecialchars($estate->getPicture_url());?>"
                                            height="200" id="preview" alt="Image preview">
                                    </div>
                                    <div>
                    ...
                    <div class="form-panel">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="number" class="form-control" name="charge_price"
                                    value="<?= htmlspecialchars($estate->getCharge_price());?>"
                                    placeholder="Prix des charges en €">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="number" class="form-control" name="price"
                                    value="<?= htmlspecialchars($estate->getPrice());?>" placeholder="Prix en €">
                            ...
                            <div class="col-sm-4">
                                <input type="number" class="form-control" name="fees"
                                    value="<?= htmlspecialchars($estate->getFees());?>" placeholder="Honoraire en €">
                    ...
                    <div class="form-panel">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <input type="submit" name="submit" id="submit" class="btn btn-theme05"
                                    value="Mettre à jour">
                            </div>
                        </div>
