                    ...
                    <div class="single-property-slider">
                        <ul class="bxslider">
                            ...
                            <?php 
                                ...
                                ?>
                            <li>
                                <a href="#"><img src="img/upload/<?=$picture->getFile();?>"
                                        alt="<?=$picture->getFile();?>"></a>
                            </li>
                            <?php
                                    }
                                ?>
                            ...
                            <div class="tab-pane fade" id="details">
                                <div class="details-content tab-content-padding fix">
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="single-pt-list">
                                            <ul>
                                                ...
                                                <li><strong>Pièces
                                                        :</strong><?= htmlspecialchars($estate->getRooms());?></li>
                                                <li><strong>Chambres
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="single-pt-list">
                                            <ul>
                                                <li><strong>Prix :</strong><?= htmlspecialchars($estate->getPrice());?>
                                                    €</li>
                                                <li><strong>Charge
                                                ...
                                                <li><strong>Année de construction:
                                                    </strong><?= htmlspecialchars($estate->getBuilding_year());?></li>
                                                <li><strong>Comble aménageable
                                                        :</strong><?= htmlspecialchars($estate->getConvertible_attic());?>
                                                </li>
                            ...
                            <div class="tab-pane fade" id="diagnostic">
                                <div class="diagnostic-content tab-content-padding fix">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="single-pt-list">
                                            <ul>
                                                <li><strong>Diagnostique Electrique :</strong>
                                                    <?= htmlspecialchars($estate->getLevel_energy_diagnostic());?></li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="single-pt-list">
                                            <ul>
                                                <li><strong>Diagnostique Gaz :</strong>
                                                    <?= htmlspecialchars($estate->getLevel_climat_diagnostic());?></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="single-property-footer-post">
                                ...
                                <div class="properties-content">
                                    <h3><a
                                            href="index.php?route=agent&agentId=<?= htmlspecialchars($limitAgent->getId());?>"><?= htmlspecialchars($limitAgent->getFirstname());?>
                                            <?= htmlspecialchars($limitAgent->getLastname());?></a></h3>
                                    <div class="price-detail">
