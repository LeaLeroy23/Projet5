    ...
    <body>
        <section id="container">
            ...
            <header class="header black-bg">
                ...
                <a href="index.php" class="logo"><img src="img/logo-min.png" /></a>
            ...
            <aside>
                <div id="sidebar" class="main-menu nav-collapse">
                    ...
                    <ul class="sidebar-menu" id="nav nav-accordion">
                        <p class="centered"><a href="index.php?route=profile"><img src="img/agent/<?= $this->session->get('avatar'); ?>" class="img-circle" width="80" height="80"></a></p>
                        <h5 class="centered">
